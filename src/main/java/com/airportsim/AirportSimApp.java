...
public class AirportSimApp extends Application {
    /**
     * This is the main entry point for the Airport Sim, sets up the initial window with a "Start"
     * button that leads to the config page.
     */
    @Override
    public void start(Stage stage) {
        ...
        entryScene
                .getStylesheets()
                .add(getClass().getResource("/css/style.css").toExternalForm()); // apply css
